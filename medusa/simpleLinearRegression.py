# {{{ http://code.activestate.com/recipes/578129/ (r3)
"""
...
def predictLinearRegressionConstants(x, y):
    data = zip(x, y)
    ...
    return linRegr.a, linRegr.b


def predictLinearRegressionConstantsTuples(data):
    if len(data) == 0:
        return 0, 0
...
def example():
    ...
    data = [(50, 58.0), (50, 101.0), (50, 24.0),
            (50, 24.0), (50, 35.0), (50, 36.0), (50, 2.0)]
...
if __name__ == "__main__":
    example()
# end of http://code.activestate.com/recipes/578129/ }}}
